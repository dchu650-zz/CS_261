 ...
 * @author Jessica Penick and Andrew Graham
 *
 */
public class Human extends Agent
{
	...
	public void move()
	{
		...
		else if(city.getAgents()[possPoint.x][possPoint.y]!=null)
		{
			...
			//go in a new random direction
			//			dir = rando.nextInt(4);
			//						//go in the opposite direction
			//						if(dir ==0)//if facing North
			//							dir = 2; //face south
			//						
			//						else if(dir == 1)//if facing East
			//							dir = 3; //face West
			//						
			//						else if(dir == 2)//if facing South
			//							dir = 0; //face North
			//						
			//						else if(dir == 3)//if facing West
			//							dir = 1; //face East
		}
